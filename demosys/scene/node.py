...
class Node:
    ...
    def calc_global_bbox(self, view_matrix, bbox_min=None, bbox_max=None):
        ...
        if self.mesh:
            bbox_min, bbox_max = self.mesh.calc_global_bbox(view_matrix, bbox_min=bbox_min, bbox_max=bbox_max)

        for child in self.children:
            bbox_min, bbox_max = child.calc_global_bbox(view_matrix, bbox_min=bbox_min, bbox_max=bbox_max)
